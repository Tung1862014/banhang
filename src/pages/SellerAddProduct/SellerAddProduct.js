...
function SellerAddProduct() {
    ...
    function handleSubmitAddProduct(
        ...
        if (nameProduct === '') {
            ...
            formData.append('khuyenmai', promotion);
            formData.append('DM_id', category);
            axios({
                method: 'POST',
                url: `${process.env.REACT_APP_URL_NODEJS}/seller/product/add`,
                data: formData,
                headers: {
            ...
            handleDescribeProduct(describeProduct);
            handleImageProduct(image);
            handleImageProduct(imageTwo);
            handleImageProduct(imageThree);
        }
    }

    function handleDescribeProduct(describeProduct) {
        axios
            .post(`${process.env.REACT_APP_URL_NODEJS}/seller/product/add/describe`, {
    ...
    function handleImageProduct(image) {
        ...
        axios({
            method: 'POST',
            url: `${process.env.REACT_APP_URL_NODEJS}/seller/product/add/image`,
            data: formData,
            headers: {
                'Content-Type': 'multipart/form-data',
            },
