                            ...
                            <div className={cx('order-title')}>
                                <div className={cx('title-prefix')}>
                                    <div className={cx('user-header-view-item')}>
                                        <div className={cx('avatar')}>
                                            <img
                                                src="https://deo.shopeemobile.com/shopee/shopee-seller-live-sg/rootpages/static/vendor/copy/default-avatar.png"
                                                alt=""
                                                className={cx('image')}
                                            />
                                        </div>
                                        <div className={cx('content')}>
                                            <div className={cx('username-text-overflow')}>5kugvwlz7d</div>{' '}
                                        </div>
                                    </div>
                                    <div className={cx('id-btn')}>
                                        <span className={cx('orderid')}>ID Đơn hàng&nbsp;22080492QKCNVA</span>
                                    </div>
                                </div>
                                ...
                                <div className={cx('body-bill')}>
                                                        ...
                                                        <div className={cx('ct-item-product-inner')}>
                                                            ...
                                                            <div className={cx('ct-item-price-qty')}>
                                                                <div className={cx('ct-item-product-qty')}>
                                                                    <div className={cx('ct-item-product-num')}>x1</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className={cx('item-total')}>
                                        <div className={cx('price')}>₫164.500</div>{' '}
